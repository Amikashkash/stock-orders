...
const routes = [
  ...
  },
  {
    ...
    children: [
      ...
      { path: 'orders/:id/view', name: 'order-view', component: () => import('@/views/orders/OrderDetailsView.vue') },
      ...
      { path: 'admin/brands', name: 'admin-brands', component: () => import('@/views/admin/AdminBrandsView.vue'), meta: { adminOnly: true } },
    ],
  },
